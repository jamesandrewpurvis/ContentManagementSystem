...
<header class="p-3 bg-dark text-white">
  ...
  <div class="bg-dark text-secondary px-4 py-5 text-center">
    <div class="py-5">
      <h1 class="display-5 fw-bold text-white">Content Management System</h1>
      <div class="col-lg-6 mx-auto">
        <p class="fs-5 mb-4">Demo content management system, created using JSP and bootstrap.</p>
 ...
 <div class="container">
  <footer class="py-3 my-4">
    ...
    <p class="text-center text-muted">&COPY; 2021 - James Purvis</p>
  </footer>
</div>
